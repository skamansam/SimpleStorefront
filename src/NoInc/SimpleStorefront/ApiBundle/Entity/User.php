 ...
 * @ApiResource(iri="http://schema.org/Thing", collectionOperations={"current"={"route_name"="get_user_current"}, "get"={"normalization_context"={"groups"={"get_user"}}, "denormalization_context"={"groups"={"set_user"}}, "method"="GET"}, "post"={"normalization_context"={"groups"={"get_user"}}, "denormalization_context"={"groups"={"set_user"}}, "method"="POST"}}, itemOperations={"get"={"normalization_context"={"groups"={"get_user"}}, "denormalization_context"={"groups"={"set_user"}}, "method"="GET"}, "put"={"normalization_context"={"groups"={"get_user"}}, "denormalization_context"={"groups"={"set_user"}}, "method"="PUT"}, "delete"={"access_control"="ROLE_SUPER_ADMIN", "normalization_context"={"groups"={"get_user"}}, "denormalization_context"={"groups"={"set_user"}}, "method"="DELETE"}})
